        ...
        <div class="row min-vh-100">
            <aside class="admin-sidebar col-lg-2 p-4 d-flex flex-column">
                ...
                <nav class="nav flex-column gap-1">
                    <a class="nav-link active px-3 py-2" href="{{ route('admin.dashboard') }}">▦ <span class="ms-2">Dashboard</span></a>
                    <a class="nav-link px-3 py-2" href="{{ route('admin.users.index') }}">♧ <span class="ms-2">Użytkownicy</span></a>
                    <a class="nav-link px-3 py-2" href="{{ route('admin.leagues.index') }}">⚽ <span class="ms-2">Ligi</span></a>
